        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="username" id="username" lay-verify="required|account" placeholder="用户名或者邮箱" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
...
<script src="${pageContext.request.contextPath}/statics/layui/lib/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<script>
